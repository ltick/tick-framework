...
type KvstoreHandler interface {
	...
	Zrange(key interface{}, start, end interface{}) (interface{}, error)
	Zrevrange(key interface{}, start, end interface{}) (interface{}, error)
	ZrangeByScore(key interface{}, min, max interface{}, limits ...interface{}) (interface{}, error)
	ZrevrangeByScore(key interface{}, min, max interface{}, limits ...interface{}) (interface{}, error)
